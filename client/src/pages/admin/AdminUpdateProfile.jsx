...
const AdminUpdateProfile = () => {
  ...
  const updateUserDetails = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_REPLIT_URL}/api/user/update/${currentUser._id}`, {
        method: "POST",
        headers: {
  ...
  const updateUserPassword = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_REPLIT_URL}/api/user/update-password/${currentUser._id}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
